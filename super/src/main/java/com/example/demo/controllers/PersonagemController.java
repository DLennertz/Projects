...
public class PersonagemController {
	...
	@PostMapping("")
	public ResponseEntity<Personagem> createPersonagem(@RequestPart(name="personagem") Personagem personagem){
		return new ResponseEntity<Personagem>(personagemService.createPersonagem(personagem), HttpStatus.CREATED);
	}
	
	@PutMapping("")
	public ResponseEntity<Personagem> updatePersonagem(@RequestPart(name="personagem") Personagem personagem){
